...
class QbsPlugin(snapcraft.BasePlugin):
    ...
    def __init__(self, name, options, project):
        ...
        self.build_packages.extend(['gcc', 'clang'])
    ...
    def build(self):
        ...
        qbs_dirname = os.path.abspath(os.path.join(dirname, '../../parts/qbs/install/usr/local/bin'))
        
        env['PATH'] = qbs_dirname + ':' + env['PATH']
        print(env)

        self.run(['which', 'qbs'], env=env)
